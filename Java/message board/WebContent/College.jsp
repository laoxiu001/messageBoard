		...
		<div class="navbar navbar-default" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-responsive-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a
						href="<%=basePath%>/College.jsp?object=all">学院留言板</a></li>
				...
				<div class="raw">
					<div class="greycontent_visiable">
						<div class="fr" style="width: 100%">
							<div class="bluebar">
								<a><img src="img/college.png"> 学院留言板</a>
							</div>
						</div>
						<div class="message_bottom_left fl">
							<ul>
								<li class="clrli"><a class="clra"
									href="College.jsp?object=数学与财经学院">●数学与财经学院●</a></li>
								<li class="clrli"><a class="clra"
									href="College.jsp?object=机电学院">●机电学院●</a></li>
								<li class="clrli"><a class="clra"
									href="College.jsp?object=文传学院">●文传学院●</a></li>
								<li class="clrli"><a class="clra"
									href="College.jsp?object=网络工程学院">●网络工程学院●</a></li>
								<li class="clrli"><a class="clra"
									href="College.jsp?object=外国语学院">●外国语学院●</a></li>
								<li class="clrli"><a class="clra"
									href="College.jsp?object=经济管理学院">●经济管理学院●</a></li>
								<li class="clrli"><a class="clra"
									href="College.jsp?object=体育学院">●体育学院●</a></li>
							</ul>
						</div>
								...
								<table width="100%">
									...
									<%
										...
										if (object.equals("all")) {
											sql = "Select * from t_message where m_object1 = '学院' order by m_time desc";
										} else {
					...
					<div style="margin-top: 20px;">
						<form
							action="College.jsp?object=<%=object%>&pageIndex=<%=pageIndex%>">
							<table>
								<a class="button"
									href="College.jsp?object=<%=object%>&pageIndex=1">首 页</a>
								<a class="button"
									href="College.jsp?object=<%=object%>&pageIndex=<%=pageIndex - 1%>">上一页</a>
								<a class="button"
									href="College.jsp?object=<%=object%>&pageIndex=<%=pageIndex + 1%>">下一页</a>
								<a class="button"
									href="College.jsp?object=<%=object%>&pageIndex=<%=totalPage%>">末
									页</a>
								<a class="jump">第</a>
								<input class="jump" name="pageIndex" type="text"
									value="<%=pageIndex%>" style="width: 30px;">
								<input class="jump" name="object" type="text"
									value="<%=object%>" style="width: 30px; display: none;">
								<a class="jump">页</a>&nbsp;/&nbsp;
								<a class="jump">共</a>
