...
<div class="container" style="width:1300px;">
	...
	<div class="middle">
		<div id="search_result">
			<div class="bluebar">
				<a><img src="<%=basePath%>/img/Message_wrong.png"> 留言失败</a>
			</div>
			<div class="greycontent_visiable">
				...
				<div class="result">
					<div class="result_content">
						<a>对不起，留言失败，请修正后重试。<br /> <a>原因可能为：</a> <a class="red"><%=request.getAttribute("result")%></a>
							</br> 如果您认为此错误不该发生，请联系管理员。
						</a>
					</div>
				</div>
			</div>
