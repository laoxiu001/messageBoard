...
<div class="container" style="width:1300px;">
	...
	<div class="middle">
		<div id="search_result">
			<div class="bluebar">
				<a><img src="<%=basePath%>/img/Message_succed.png"> 留言成功</a>
			</div>
			<div class="greycontent_visiable">
				...
				<div class="result">
					<div class="result_content">
						<a>恭喜，留言成功。请复制您的留言编号并保存，用于查询后续回复</a><br /> <a>留言编号：</a> <input
							onclick="Copy(this)" value=<%=request.getAttribute("id")%>
							style="width: 80px; height: 30px;"> <a>或者</a> <a
							href="Details.jsp?index=<%=request.getAttribute("id")%>">点我查看</a>
					</div>
				</div>
			</div>
		</div>
