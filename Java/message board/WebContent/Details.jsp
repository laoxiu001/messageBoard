	...
	<div class="container-fluid">
		<div id="detail">
			...
			<div id="#detail_bottom">
				<table width="100%">
					<tr class="single">
						<td style="width:100px"><a>留言编号：</a></td>
						<td><a> <%
					...
					<tr class="double">
						<td><a>留言标题：</a></td>
						<td><a> <% out.print(map.get("title"));%>
						</a></td>
					</tr>
					<tr class="single">
						<td><a>留言内容：</a></td>
						<td><a> <% out.print(map.get("m_content"));%>
						</a></td>
					</tr>
					<tr class="double">
						<td><a>留言时间：</a></td>
						<td><a> <% out.print(map.get("m_time_s"));%>
						</a></td>
					</tr>
					<tr class="single">
						<td><a>用户：</a></td>
						<td><a> <% out.print(map.get("user"));%>
						</a></td>
					</tr>
					<tr class="double">
						<td><a>学号：</a></td>
						<td><a> <% out.print(map.get("number"));%>
						</a></td>
					</tr>
					<tr class="single">
						<td><a>受理单位：</a></td>
						<td><a> <% out.print(map.get("reply"));%>
						</a></td>
					</tr>
					<tr class="double">
						<td><a>回复内容：</a></td>
						<td><a> <% out.print(map.get("r_content"));%>
						</a></td>
					</tr>
					<tr class="single">
						<td><a>回复时间：</a></td>
						<td><a> <% out.print(map.get("r_time_s"));%>
						</a></td>
					</tr>
					<tr class="double">
						<td><a>点击率：</a></td>
						<td><a> <% out.print(map.get("click"));%>
						</a></td>
					</tr>
					<tr class="single">
						<td><a>留言类型：</a></td>
						<td><a> <% out.print(map.get("type"));%>
						</a></td>
					</tr>
				</table>
				</div>
