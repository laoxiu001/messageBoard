		...
		<div class="container_fluid">
			...
			<div class="greycontent_visiable">
				...
				<div style="margin-top:20px;">
					<form action="Hot.jsp?pageIndex=<%=pageIndex%>">
						<table>
							<a class="button" href="Hot.jsp?pageIndex=1">首 页</a>
							<a class="button"
								href="Hot.jsp?pageIndex=<%=pageIndex - 1%>">上一页</a>
							<a class="button"
								href="Hot.jsp?pageIndex=<%=pageIndex + 1%>">下一页</a>
							<a class="button" href="Hot.jsp?pageIndex=<%=totalPage%>">末
								页</a>
							<a class="jump">第</a>
