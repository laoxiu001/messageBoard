		...
		<div class="container_fluid">
			...
			<div class="greycontent_visiable">
				...
				<div style="margin-top:20px;">
					<form action="Latest.jsp?pageIndex=<%=pageIndex%>">
						<table>
							<a class="button" href="Latest.jsp?pageIndex=1">首 页</a>
							<a class="button"
								href="Latest.jsp?pageIndex=<%=pageIndex - 1%>">上一页</a>
							<a class="button"
