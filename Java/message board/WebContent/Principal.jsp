		...
		<div class="navbar navbar-default" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-responsive-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a
						href="<%=basePath%>/Principal.jsp?object=all">校长留言板</a></li>
				...
				<div class="raw">
					<div class="greycontent_visiable">
						<div class="fr" style="width: 100%">
							<div class="bluebar">
								<a><img src="img/principal.png"> 校长留言板</a>
							</div>
							<div class="message_bottom_left fl">
								<ul>
									<li class="clrli"><a class="clra"
										href="Principal.jsp?object=书记">●书记留言板●</a></li>
									<li class="clrli"><a class="clra"
										href="Principal.jsp?object=校长">●校长留言板●</a></li>
									<li class="clrli"><a class="clra"
										href="Principal.jsp?object=分管校长">●分管校长留言板●</a></li>
								</ul>
							</div>
									...
									<table width="100%">
										...
										<%
											...
											if (object.equals("all")) {
												sql = "Select * from t_message where m_object1 = '校长' order by m_time desc";
											} else {
					...
					<div style="margin-top: 20px;">
						<form
							action="Principal.jsp?object=<%=object%>&pageIndex=<%=pageIndex%>">
							<table>
								<a class="button"
									href="Principal.jsp?object=<%=object%>&pageIndex=1">首 页</a>
								<a class="button"
									href="Principal.jsp?object=<%=object%>&pageIndex=<%=pageIndex - 1%>">上一页</a>
								<a class="button"
									href="Principal.jsp?object=<%=object%>&pageIndex=<%=pageIndex + 1%>">下一页</a>
								<a class="button"
									href="Principal.jsp?object=<%=object%>&pageIndex=<%=totalPage%>">末
									页</a>
								<a class="jump">第</a>
