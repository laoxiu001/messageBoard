 ...
 * Generated at: 2017-03-26 07:58:44 UTC
...
public final class Message_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>学生交流平台-发表留言</title>\r\n");
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
      ...
      out.write("\thref=\"");
      out.print(basePath);
      out.write("/assets/themes/default/sangarSlider.css\"\r\n");
      out.write("\ttype=\"text/css\" media=\"all\">\r\n");
      out.write("<link rel=\"stylesheet\"\r\n");
      out.write("\thref=\"");
      out.print(basePath);
      out.write("/assets/themes/default/default.css\" type=\"text/css\"\r\n");
      out.write("\tmedia=\"all\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<img src='");
      out.print(basePath);
      out.write("/img/lb1.jpg' /> <a href='#'></a>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class='sangar-content'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<img src='");
      out.print(basePath);
      out.write("/img/lb2.jpg' /> <a href='#'></a>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class='sangar-content'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<img src='");
      out.print(basePath);
      out.write("/img/lb3.jpg' /> <a href='#'></a>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<a><img src=\"img/message.png\"> 发表留言</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div id=\"message_bottom\">\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.print(token);
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- 隐藏域存储token令牌 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><a style=\"font-size: 16px width:80px\">是否匿名:</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td> <input type=\"radio\" name=\"choose\" checked=\"checked\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tonclick=\"anonymous()\">是 <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"choose\" onclick=\"unanonymous()\">否&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr style=\"height: 50px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><a style=\"font-size: 16px width:80px\">用 户：</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"user\" name=\"user\" type=\"text\" style=\"width: 70px; height: 30px;\" value=\"保密\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr style=\"height: 50px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><a style=\"font-size:16px;width:80px;\">学 号：</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"number\" name=\"number\" type=\"text\" style=\"width: 100px; height: 30px;\" value=\"保密\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t</tr style=\"height: 50px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><a style=\"font-size:16px;width:80px;\">标 题：</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"title\" name=\"title\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"height: 30px;\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr style=\"height: 50px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td style=\"font-size:16px;width:80px;\"><a>留言类型：</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select name=\"type\" id=\"type\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"点我选择\">点我选择</option>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr style=\"height: 50px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td style=\"font-size:16px;width:80px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a>留言对象：</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select name=\"m_object\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"m_object\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"false,false\">-----点我选择-----</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"false,false\">-------校 长-------</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"校长,高层校长\">高层校长</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"校长,分管校长\">分管校长</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"校长,学院校长\">学院校长</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"false,false\">-------部 门-------</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"部门,行政部门\">行政部门</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"部门,后勤服务部门\">后勤服务部门</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"部门,食堂监管部门\">食堂监管部门</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"部门,校园安保部门\">校园安保部门</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"部门,财务部门\">财务部门</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"false,false\">-------学 院-------</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"学院,数学与财经学院\">数学与财经学院</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"学院,机电学院\">机电学院</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"学院,文传学院\">文传学院</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"学院,网络工程学院\">网络工程学院</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"学院,外国语学院\">外国语学院</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"学院,体育学院\">体育学院</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td style=\"font-size:16px;width:80px;\">留言内容：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><textarea id=\"m_content\" name=\"m_content\" id=\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tcols=\"55\" rows=\"10\"></textarea></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr style=\"height: 50px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td style=\"font-size:16px;width:80px;\">验 证 码：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"code\" alt=\"看不清？点我刷新验证码\" id=\"checkCode\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tonclick=\"createCode()\"></div> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"float: left; width: 60px; height: 30px;\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"inputCode\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"submit\" name=\"submit\" id=\"submit\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"提交\" class=\"button\" onclick=\"return publish()\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
